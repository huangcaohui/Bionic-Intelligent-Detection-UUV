...
//	GPIO_PinRemapConfig(GPIO_FullRemap_TIM1 ,ENABLE);
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8|GPIO_Pin_9|GPIO_Pin_10|GPIO_Pin_11; //TIM1
	...
	TIM_TimeBaseStructure.TIM_RepetitionCounter = 0; //重复溢出多少次才给你来一个溢出中断
...
//	GPIO_PinRemapConfig(GPIO_FullRemap_TIM8 ,ENABLE);
	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_8|GPIO_Pin_9; //TIM8
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;  //复用推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	...
	TIM_TimeBaseStructure.TIM_ClockDivision = 0; //设置时钟分割:TDTS = Tck_tim
	TIM_TimeBaseStructure.TIM_CounterMode = TIM_CounterMode_Up;  //TIM向上计数模式
	TIM_TimeBaseStructure.TIM_RepetitionCounter = 0; //重复溢出多少次才给你来一个溢出中断，周期计数值
